...
class ZCoderClient:
    ...
    def __init__(
        ...
        router: Optional[PublicAPIV1Router] = None,
    ):
    ...
    def create_job(self, task: str, idempotency_key: Optional[str] = None) -> Dict[str, Any]:
    ...
    def register_webhook(self, url: str, event_types: Optional[List[str]] = None) -> Dict[str, Any]:
